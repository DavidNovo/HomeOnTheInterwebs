---
title: "Design Challenge_021"
date: 2020-08-23T20:01:24-05:00
draft: true
layout: static/css/design-021.css
---
## Summary (h2 header) {#summary class="summary"}
At-rules are CSS statements that instructs CSS how to behave.  Time to try one, the @media rule.  To make the grid more responsive. Before using the @media rule, the grid would just disapear if the window got to small.

{{% div class="summary-grid" %}}

### Your name >here<{class="firstcolumnallrows"}

### ---------------------------------------------{class="secondfifthcolumnsthirdrow"}

### What do >you<> want to be?

### Supremeable {#logo}

##### {class="fifthcolumnallrows pattern-dots"}

## gReen mAchine {#logogreen}

## How old do you want to be?

### What will your name mean?

## What will your tombstone say? Should >anyone< care?
