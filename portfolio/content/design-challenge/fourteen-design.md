---
title: "Fourteen Design"
date: 2020-07-27T19:40:24-05:00
draft: false
layout: static/css/fourteen.css
---
# Summary (h1 header) {#summary class="summary one"}

This is using CSS Grid again.  I did not add div tags to the markdown; I added some attributes to two CSS selectors: P and the header selector. The new attributes define which block-element goes in which column.  

Not a bad thing, but these two paragraphs shouyld be closer together, but they are in different rows.

Also note, paragraph and the headers are the only block elements with the grid-column attrubyte, the other block level elements, like lists, are still being put into default grid columns.  In this case, the third grid column.
...
ingemuitque nullo longaque postquam.{class="two"}
