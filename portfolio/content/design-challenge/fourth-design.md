...
Playing with porportion and type size.  

What makes some type work and other type not work?  What is the best size for type? This design playes with the size of type and what makes a good ratio of type sizes.  In this case the font-size of the text body is 12px. The ratio I am using is 5:8 or minor sixth.
