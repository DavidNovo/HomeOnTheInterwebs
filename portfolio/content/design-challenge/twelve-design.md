---
title: "Twelve Design"
date: 2020-07-14T16:44:26-05:00
draft: false
layout: static/css/descendant.css
---
# Summary (h1 header) {#summary class="summary"}

Well, this is playing with creating my own @font-face and using 'em' for positioning.  Interesting stuff, a way of creating relative position of item using the font-size as a guide.  

I also experimented with changing the writing mode from horizontal to vertical.  Just something new.
